...
class KaiAgentApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun kaiSecurityPost(securityRequest: SecurityRequest) : SecurityResponse {
        val localVarResponse = kaiSecurityPostWithHttpInfo(securityRequest = securityRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as SecurityResponse
     ...
     * Executes Kai&#39;s security-focused analysis protocols
     * @param securityRequest 
     * @return ApiResponse<SecurityResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun kaiSecurityPostWithHttpInfo(securityRequest: SecurityRequest) : ApiResponse<SecurityResponse?> {
        val localVariableConfig = kaiSecurityPostRequestConfig(securityRequest = securityRequest)

        return request<SecurityRequest, SecurityResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation kaiSecurityPost
     *
     * @param securityRequest 
     * @return RequestConfig
     */
    fun kaiSecurityPostRequestConfig(securityRequest: SecurityRequest) : RequestConfig<SecurityRequest> {

...
@NonNullApi
public class GenesisOsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public GenesisOsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
